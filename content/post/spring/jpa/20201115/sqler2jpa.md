...
처음에 JPA를 공부할때는 @Entity랑 @Id, @OneToMany, @ManyToOne, @OneToOne 이런 JPA 어노테이션 위주로만 사용을하고. @Table, @Column, @JoinColumns 이런것들은 어느정도 능숙해졌을 때 다루는 것을 추천한다.(~~나도 얘들은 잘모름~~)
